...
\expandtcard{fev}{card}{%
    ...
    \pagenode[draw]{-1.1,0.1in}{1.1in,-0.4in}{
        \vfil \centering \emph{
        Возбуждает ли ИМЯ мысли/фантазии о....}
        }
            \pagenode[draw,line width=0.02in]{-1.1in,-0.5in}{1.1in,-1.2in}{\hfil \vfil \centering \textbf{\thecardtext} ? \vfil \hfil}%
