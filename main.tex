...
\expandtcard{fev}{card}{%
    ...
    \pagenode[draw]{-1.1,0.05in}{1.1in,-1.15in}{\raggedright \ifthenelse{\equal{\therandomdir}{EVENT}}{{\textbf{\thecardtext}}}{\emph{Возбуждают ли ИМЯ мысли (фантазии)} {\textbf{\thecardtext}}?} }%
