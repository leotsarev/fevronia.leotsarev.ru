...
\expandtcard{fev}{card}{%
    ...
    \emph{
    Возбуждают ли ИМЯ мысли (фантазии)} \textbf{\thecardtext}? }%
    ...
    \linenode[]{-1.1,-1.55in}{1.1,-1.65}{{\tiny fevronia.leotsarev.ru}}
...
\Repeat{3}{\begin{tcard}{spec}%
    \cardtext{\textbf{Все пересаживаются}. После этого потяните еще одну карту.}%
\end{tcard}
}
