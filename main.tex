...
\expandtcard{fev}{card}{%
    ...
    \pagenode[draw]{-1.1,0.1in}{1.1in,-1.2in}{
    \vfil \centering \emph{
    Возбуждают ли ИМЯ мысли/фантазии} \textbf{\thecardtext}? \vfil \hfil}%
...
{\csvtype=type,\csvcardtext=cardtext,\csvdirection=direction,\csvcount=count,
\csvpretext=pretext}% assignment
